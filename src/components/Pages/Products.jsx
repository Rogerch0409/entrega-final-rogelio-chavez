...
<Card style={{ width: '18rem' }} className ="card h-100 text-center p-4" key={product.id}>
      ...
      <Card.Body>
        ...
        <button className="btn btn-outline-dark"><NavLink href={`/products/${product.id}`}>Comprar</NavLink></button>
      </Card.Body>
    </Card>
</div>
        </>
